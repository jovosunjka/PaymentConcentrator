...
start "pki-frontend" npm start --prefix pki_microservice\payment-microservice-frontend
echo payment-microservice-frontend is running!

:: start "payment-microservice-frontend" npm start --prefix payment_microservice\Client\application

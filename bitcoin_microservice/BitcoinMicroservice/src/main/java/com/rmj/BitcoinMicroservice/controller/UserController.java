...
import com.rmj.BitcoinMicroservice.dto.*;
import com.rmj.BitcoinMicroservice.security.TokenUtils;
import com.rmj.BitcoinMicroservice.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity registrate(@RequestBody RegistrationUserDTO userDTO) {
        ...
        boolean registered = userService.register(userDTO.getUsername(), userDTO.getPassword(),
        		userDTO.getRepeatedPassword(), userDTO.getProperties(), userDTO.getCurrency());
    	...
    	userDTOs.getUsers().stream()
    				.forEach(user -> {
    					boolean registered = userService.register(user.getUsername(), user.getPassword(),
                                user.getRepeatedPassword(), user.getProperties(), user.getCurrency());

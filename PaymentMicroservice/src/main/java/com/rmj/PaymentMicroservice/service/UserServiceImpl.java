...
public class UserServiceImpl implements UserService {
	...
	@Override
	public boolean register(String name, String username, String password, String repeatedPassword) {
		if (name == null || username == null || password == null || repeatedPassword == null)
			return false;

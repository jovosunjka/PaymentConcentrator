...
var ChoosePaymentComponent = /** @class */ (function () {
    function ChoosePaymentComponent(httpService, toastr) {
        this.httpService = httpService;
        this.toastr = toastr;
        this.relativeUrlForPaymentTypes = "/payment/types";
        this.paymentTypes = [];
    }
    ChoosePaymentComponent.prototype.ngOnInit = function () {
        this.getPaymentTypes();
    };
    ChoosePaymentComponent.prototype.getPaymentTypes = function () {
        var _this = this;
        this.httpService.getAll(this.relativeUrlForPaymentTypes)
            .subscribe(function (paymentTypes) {
            _this.paymentTypes = paymentTypes;
            _this.toastr.success('The payment types have been successfully delivered!');
        }, function (err) {
            _this.paymentTypes = [];
            _this.toastr.error('The payment types have not been successfully delivered!');
        });
    };
    ChoosePaymentComponent.ctorParameters = function () { return [
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.getAll = function (relativeUrl) {
        return this.http.get(this.baseUrl + relativeUrl);
    };
    HttpService.prototype.get = function (relativeUrl) {
        // const params: HttpParams = new HttpParams().set('_id',id);
        return this.http.get(this.baseUrl + relativeUrl);
    };
    HttpService.prototype.getById = function (relativeUrl, id) {
        // const params: HttpParams = new HttpParams().set('_id',id);
        return this.http.get(this.baseUrl + relativeUrl + ("/" + id));
    };
    HttpService.prototype.put = function (relativeUrl, t) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        return this.http.put(this.baseUrl + relativeUrl, t, { headers: headers });
    };
    HttpService.prototype.save = function (relativeUrl, t) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        return this.http.post(this.baseUrl + relativeUrl, t, { headers: headers });
    };
    HttpService.prototype.post = function (relativeUrl, t) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        return this.http.post(this.baseUrl + relativeUrl, t, { headers: headers });
    };
    HttpService.prototype.delete = function (relativeUrl, id) {
